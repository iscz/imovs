package com.luuo.imovs.user.generator;
...
public class EntityGenerator extends ImovsUserApplicationTests {
    ...
    // DAO的包路径
    private final String parentPackage = "com.luuo.imovs.user";
    // 待生成的表名，注意是覆盖更新
