package com.luuo.imovs.common.config;
...
public class GlobalExceptionHandler {
    ...
    public ResponseResult parameterMissingExceptionHandler(MissingServletRequestParameterException e) {
        log.error("", e);
        return ResponseResult.failed(ResultEnum.PARAMETER_ERROR, "请求参数 " + e.getParameterName() + " 不能为空");
    }
    ...
    public ResponseResult parameterBodyMissingExceptionHandler(HttpMessageNotReadableException e) {
        log.error("", e);
        return ResponseResult.failed(ResultEnum.PARAMETER_ERROR, "参数体不能为空");
    }
    ...
    public ResponseResult parameterExceptionHandler(MethodArgumentNotValidException e) {
        ...
        if (exceptions.hasErrors()) {
            ...
            if (!errors.isEmpty()) {
                ...
                return ResponseResult.failed(ResultEnum.PARAMETER_ERROR, fieldError.getField() + fieldError.getDefaultMessage());
            }
        }
        return ResponseResult.failed(ResultEnum.PARAMETER_ERROR);
    }
}
